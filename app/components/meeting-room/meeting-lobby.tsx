					...
					<div className="flex flex-row items-center space-y-3 p-6 text-neutral-900">
						<div className="flex flex-col">
							...
							<div className="flex flex-row items-center space-x-2">
								...
								<span className="text-lg">{formatDatetime(new Date("2025-03-03 22:22:22"), "EEE, MMM d h:mm a")}</span>
							</div>
						</div>
						<div className="flex flex-row items-center space-x-3 ml-auto">
							<Button label="Leave" onClick={() => window.history.back()} className=" !w-22 !bg-error-400 text-white" />
				...
				<div className="flex flex-row justify-center w-full py-1 space-x-3 text-neutral-900">
					<ResponsiveActionMenu
						icon={
							<div
								className={`
                flex flex-row items-center space-x-1 cursor-pointer hover:text-neutral-700 rounded-full px-3
