...
export default function CategoryListModal({ isOpen, onClose, categories, onEditClick, onDeleteClick }: Props) {
	return (
		<ModalCmp isOpen={isOpen} handleClose={onClose} showCloseBtn>
